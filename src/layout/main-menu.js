export default {
  ...
  render(e) {
    return e('div', { attrs: { id: 'main-menu' } }, [
      e('nav', { ref: 'manus', attrs: { id: 'main-menu-container' } }, this.$tampan.menuItems.map((menu, index) => {
        switch (menu.type) {
          case 'sparator':
      ...
      e('transition', { props: { name: 'overlay-fade' } }, [
        this.$tampan.isMainMenuShow && this.$tampan.isMainMenuToggleable
          ? e('div', { staticClass: 'menu-overlay', on: { click: this.$tampan.toggleMainMenu } })
          : null
      ])
    ])
  }
